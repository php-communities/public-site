    ...
    return (
        <div className="w-full pb-[90px]">
            <div className="container mx-auto">
                ...
                <div className="mx-auto mb-[90px] max-w-[980px] text-center text-[62px] font-bold leading-[1.23] text-blue">
                    Текстовые и видео каналы и чаты, чтобы оставаться в курсе
                </div>

                <Accordion collapsible type="single">
                    <AccordionItem value="news" className="border-y border-y-[#eee]">
                        <AccordionTrigger className="group py-[27px] text-[24px] font-bold leading-[1.35] hover:no-underline">
